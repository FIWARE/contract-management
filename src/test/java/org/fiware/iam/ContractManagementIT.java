...
public class ContractManagementIT {
	...
	public void testCreateProductOrder() {
		String catalogId = Awaitility.await().atMost(2, TimeUnit.MINUTES).until(this::createProductCatalog, Optional::isPresent).get();
